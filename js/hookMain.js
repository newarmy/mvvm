...
var _child3 = __webpack_require__(26);

var _child4 = _interopRequireDefault(_child3);

var _child5 = __webpack_require__(27);

var _child6 = _interopRequireDefault(_child5);
...
var table = {
    '/': _child2.default,
    '/test': _child4.default,
    '/login': _child6.default
};

var spa = new _SPA2.default({
    table: table,
    // 所用导航前都要执行的函数
    beforeRouter: function beforeRouter(curUrl) {
